	...
	public class UnityInstanceProvider : Disposable
	{
		...
		public static UnityInstanceProvider Create()
		{
			...
			container.SetupProjectManager()
				...
				.RegisterType<ICustomerPartyProxyConfigurationSource,
					ProxyConfigurationSource>(new ContainerControlledLifetimeManager())
				.RegisterType
				...
				.RegisterType<ICustomerPartyService, CustomerPartyServiceProxy>()
				.RegisterType<IContactProcessor, ContactProcessor>()
