...
namespace UL.Aria.Service.Provider.SearchCoordinator.Task
{
	...
	/// 
	/// </summary>
	[QueryBuilder(TaskProgressEnumDto.Waiting)]
	public class TaskProgressWaitingQueryBuilder : QueryBuilderBase
	{
		/// <summary>
		...
		public override string BuildRefinerFilterQuery()
		{
			...
			filter[AssetFieldNames.AriaTaskStartDate].Add(string.Format(NotRangeFormat, "min",
