...
{
    /// <summary>
    /// Class to build a <see cref="Container"/> for a <see cref="Product"/>
    /// </summary>
    public class ProductContainerBuilder : ContainerBuilderBase
    {
        ...
        public static void BuildProduct(PrimarySearchEntityBase primarySearchEntityBase, Container container)
        {
            new ProductContainerBuilder().BuildContainer(primarySearchEntityBase, container);
        }
        ...
        protected override void BuildContainer(PrimarySearchEntityBase primarySearchEntityBase, Container container)
        {
            ...
            container.AvailableClaims.Add(new ContainerAvailableClaim { Claim = new UL.Aria.Service.Domain.Entity.Claim { Uri = SecuredClaims.UlProductAdministrator }, ContainerId = container.Id.Value, Value = "true" });
            ...
            if (container.CompanyId.HasValue)
            {
                ...
                container.AvailableClaims.Add(new ContainerAvailableClaim { Claim = new UL.Aria.Service.Domain.Entity.Claim { Uri = SecuredClaims.CompanyProductAdmin }, ContainerId = container.Id.Value, Value = companyId });
            }
            ...
            container.ContainerLists.Add(
                new ContainerList
                {
                    ...
                    Permissions = new List<ContainerListPermission>
                    {
                        ...
                        new ContainerListPermission
                        {
                            Claim = new System.Security.Claims.Claim(SecuredClaims.UlProductAdministrator, "true", ContainerDefinitionConstants.DefaultClaimValueType),
                            Permission = ContainerDefinitionConstants.PermissionContributor,
                            GroupName = ContainerDefinitionConstants.PrivateGroup
                        },
                        new ContainerListPermission
            ...
            if (container.CompanyId.HasValue)
            {
                ...
                modifyList.Permissions.Add(
                    new ContainerListPermission
                    {
                        Claim = new System.Security.Claims.Claim(SecuredClaims.CompanyProductAdmin, companyId, ContainerDefinitionConstants.DefaultClaimValueType),
                        Permission = ContainerDefinitionConstants.PermissionContributor,
                        GroupName = ContainerDefinitionConstants.ModifyGroup
                    });
            }
