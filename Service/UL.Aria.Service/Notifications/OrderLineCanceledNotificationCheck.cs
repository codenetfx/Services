...
namespace UL.Aria.Service.Notifications
{
	...
	/// </summary>
	public sealed class OrderLineCanceledNotificationCheck : IOrderLineNotificationCheck
	{
		/// <summary>
			...
			List<NotificationTypeDto> notifications)
		{
			...
			if (notifications.Any(x => x == NotificationTypeDto.OrderLineCanceled)) return false;
			notifications.Add(NotificationTypeDto.OrderLineCanceled);
