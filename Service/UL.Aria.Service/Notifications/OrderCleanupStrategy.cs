...
namespace UL.Aria.Service.Notifications
{
	...
	/// </summary>
	[NotificationType(NotificationTypeDto.OrderCleanup)]
	public sealed class OrderCleanupStrategy : NotificationStrategyBase<Project>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="OrderCleanupStrategy" /> class.
		/// </summary>
		/// <param name="notificationManager">The notification manager.</param>
		public OrderCleanupStrategy(INotificationManager notificationManager)
		...
		public override void Run(Project entity)
		{
			var notifications =
				_notificationManager.FetchNotificationsByEntity(entity.Id.GetValueOrDefault())
					.Where(
						x =>
							x.NotificationType == NotificationTypeDto.OrderOnHold || x.NotificationType == NotificationTypeDto.OrderCanceled);
