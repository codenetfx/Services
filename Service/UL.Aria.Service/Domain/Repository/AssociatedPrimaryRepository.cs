...
namespace UL.Aria.Service.Domain.Repository
{
    ...
    public abstract class AssociatedPrimaryRepository<E> : RepositoryPrimaryAssocatedEntityBase<E, SearchResultSetBase<E>, Sort, RefinementItem, SearchSummary>
     where E : class, IAuditableEntity, ISearchResult, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssociatedPrimaryRepository{E}" /> class.
        /// </summary>
        protected AssociatedPrimaryRepository() { }
